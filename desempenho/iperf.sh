...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 100 >> 100mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 500 >> 500mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 1000 >> 1000mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 1500 >> 1500mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 2000 >> 2000mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 2500 >> 2500mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 3000 >> 3000mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 3100 >> 3100mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 3200 >> 3200mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 6400 >> 6400mb.txt
        sleep 1;
...
do
        iperf3 -c 10.1.0.10 -u -b 10m -l 12800 >> 12800mb.txt
        sleep 1;
